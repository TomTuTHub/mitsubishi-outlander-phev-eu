...
For a ready-made dashboard card that displays all key vehicle data at a glance, check out the **[TomTuT Mitsubishi Outlander Card](https://github.com/TomTuTHub/mitsubishi-outlander-card)** — battery, range, charging status, GPS address, lock state, climate control and remote commands in one compact Lovelace card.
